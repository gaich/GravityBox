            ...
            XposedHelpers.findAndHookMethod(classDisplayPowerController, "requestPowerState",
                ...
                protected void beforeHookedMethod(final MethodHookParam param) throws Throwable {
                    ...
                    if (mLsBgLastScreenEnabled && (waitForNegativeProximity && !pendingWaitForNegativeProximity ||
                        ...
                        final Object displayManagerGlobal = XposedHelpers.getObjectField(displayManager, "mGlobal");
                        final int display0 = ((int[])XposedHelpers.callMethod(displayManagerGlobal, "getDisplayIds"))[0];
